$(document).ready(function(){
    ...
    const buttons = [
        ...
        },
        {
            ...
            html: `
            <section id="hover-underline" class="button-area" data-anime="right">
        ...
        {
            title: "ripple effect",
            html: `<section id="ripple-effect" class="button-area">
            <button id="ripple-button" class="animated-button ripple-button ripple-effect" 
            data-animation="animation ripple">RIPPLE EFFECT</button></section>`,
            css: `.ripple-button {
                position: relative;
                overflow: hidden;
                cursor: pointer;
    ...
    buttons.forEach(button => {
        ...
        <nav class="nav-buttons">
            <button class="code-button html-button" aria-label="HTML">HTML</button>
            <button class="code-button css-button" aria-label="CSS">CSS</button> |
            <button class="code-button result-button" aria-label="Resultado">RESULT</button>
         `;

        //Adicionando o botão js apenas se houver código js
        if(button.javascript){
            navButtons += `<button class="code-button js-button area-label="JS">JS</button>`; 
        }

        navButtons += `</nav>`; //Fechando a tag nav
        
        section.innerHTML = `
            <h3 class="code-title">${button.title}</h3>
            ${navButtons}
            <section class="html-code-area html-code code-invisible code-area">
                <h3>Código HTML</h3>
                <pre><code></code></pre>
            </section>
            <section class="css-area-code css-code code-invisible code-area">
                <h3>Código CSS</h3>
                <pre><code></code></pre>
            </section>
            <section class="js-area-code js-code code-invisible code-area">
                <h3>Código JS</h3>
                <pre><code></code></pre>
            </section>
    ...
    function visibilityButton(codeVisible){
        if(codeVisible == 'HTML-button'){
            ...
            $('.js-area-code').hide(); //Mostra a caixa de código JS
            ...
            $('.js-area-code').toggleClass('active'); //Adiciona a classe active 

            //Alterando a visibilidade da caixa de código 
            $('.html-code-area').hide(); //Mostra a caixa de código HTML
            $('.css-area-code').hide(); //Mostra a caixa de código CSS
            $('.js-area-code').show(); //Esconde a caixa de código JS
            $('.result-area').hide(); //Mostra a caixa de resultado
